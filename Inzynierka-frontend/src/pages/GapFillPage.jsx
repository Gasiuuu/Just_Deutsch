...
function GapFillPage() {
    ...
    const renderSentence = () => {
        ...
        const parts = sentenceData.sentence.split(/(_+)/g);
        ...
        return parts.map((part, i) => {
            ...
            if(m) {
                ...
                return (
                    <span key={i} className="underline">{line}</span>
                )
            }
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        if(userSolution.trim().toLowerCase() === sentenceData.missing_world.toLowerCase()) {
            setIsCorrect(true)
